...
In order to choose suitable features for the model, the correlation among different features is studied. Feature selection is essential to simplify the model and consequently reduce computational expenses during the training phase. The process of feature selection follows a statistical technique known as the High Correlation Filter, as proposed by \bcitet{Abebe.2020}. This method treats pairs of features with correlation coefficients exceeding 0.7 as a single entity. Nonetheless, the process of selecting highly correlated features must align with established physical principles. Hence, feature selection in this study is predominantly guided by physical reasoning, and this principle takes precedence over purely statistical considerations.\\

...
To further improve the accuracy of energy prediction, interpolation from measurements of towing resistance test \bcitet{XiaoLang.2020}, or possibly calculated resistance from CFD simulations should be performed. While this may decrease the usage generalibility of the proposed methodology, the specificity of this method will improve the accuracy. This is attributed to the reduction in assumptions made, and in some cases possibly none, which would enable a closer simulation of real-world sailing conditions.\\

...
The predicted SOG is then converted to STW using the methodology presented in \Cref{sec:SOG_corr}. Then the resistance components are estimated using Holtrop-Mennen method. Descriptive statistics of the estimated resistances and resulting power is shown in 
...
\begin{table}[h]
    ...
    \hline
    \end{tabular}}
\caption{Descriptive statistics of SOG Prediction}\label{tbl:SOG_presadd_descriptive}
\end{table}
